...
public class ApiServiceShould {
    ...
    public void setUp() throws Exception {
        ...
        realRetrofitApiService = new RetrofitApiServiceImpl(InstrumentationRegistry.getContext(), gson, realPlatformIdentifier);
        realRetrofitApiService.setBaseUrl(serverBaseUrl);
    ...
    public void apiservice_should_throw_an_unknown_host_exception() throws Exception {
        ...
        retrofitApiService.setBaseUrl("http://localhost/");
